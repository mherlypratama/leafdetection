...
filepath = 'D:\MSIB\2_GITHUB\Plant-Leaf-Disease-Prediction\model.h5'
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join(
            'C:/Users/Madhuri/AppData/Local/Programs/Python/Python38/Tomato_Leaf_Disease_Prediction/static/upload/', filename)
        file.save(file_path)
